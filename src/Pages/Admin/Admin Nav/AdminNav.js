...
const AdminNav = () => {
  ...
  return <div className='adminNav_container'>
      ...
      <div className="nv_links">
          <Link to={'/admin/home'} className='admNav_link'>Dashboard</Link>
          <Link to={'/admin/addpost'} className='admNav_link'>Add Post</Link>
          <Link to={'allposts'} className='admNav_link'>View All Post</Link>
          <Link className='admNav_link'>Pending Posts</Link>
          <Link className='admNav_link'>Edit Post</Link>
          <Link to={'/admin/newsCategories'} className='admNav_link'>News Categories</Link>
